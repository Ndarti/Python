...
#https://api.telegram.org/bot7817172796:AAEpCDT_1nXbhSm9Uy_FJ8QlOmSx-eUq2W8/getUpdates
def send(id, text):
    params = [{"id": id, "text": text}]
    print(params)
    response = requests.post(URL + "sendMessage", params=params)
    #URL = f'https://api.telegram.org/bot7817172796:AAEpCDT_1nXbhSm9Uy_FJ8QlOmSx-eUq2W8/sendMessage'
